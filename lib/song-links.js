...
const cleanTitle = value => normalize(value).replace(/\b(ao vivo|live|official video|video oficial|official audio|audio oficial|lyric video)\b/g, '').replace(/\s+/g, ' ').trim();
